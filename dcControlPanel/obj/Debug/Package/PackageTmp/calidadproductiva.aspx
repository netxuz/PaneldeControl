<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="calidadproductiva.aspx.cs" Inherits="dcControlPanel.calidadproductiva" %>
...
<body onload="simple_reloj();" onunload="stop();">
  <form id="form1" runat="server">
    ...
    <asp:HiddenField ID="hdd_mensaje" runat="server" Value="" />
      ...
      <tr>
        ...
        <td class="tdRightTitle">
          ...
          <table border="0" style="width: 90%; align-content: center;">
            <tr>
              <td>
                <label class="titSubControlPanel">Calidad Producida</label></td>
              <td align="right">
        ...
        <td colspan="3">
          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
            <tr>
              ...
              <td class="tdPieCalidad" style="width: 80%"></td>
              <td style="width: 10%; vertical-align: top;">
