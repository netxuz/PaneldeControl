<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="medicionmanagerp1.aspx.cs" Inherits="dcControlPanel.medicionmanagerp1" %>
        ...
        <td colspan="3">
          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
            <tr>
              ...
              <td id="pie" runat="server" style="width: 80%"></td>
              <td style="width: 10%; vertical-align: top;">
