<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="analista_segnivel.aspx.cs" Inherits="dcControlPanel.analista_segnivel" %>
...
<body onload="simple_reloj();" onunload="stop();">
  <form id="form1" runat="server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; align-content: center;">
      <tr>
        <td>
          <asp:Image ID="imglogo" ImageUrl="images/logos/logodebtcontrol.jpg" CssClass="imgLogo" runat="server" />
        </td>
        ...
        <td class="tdRightTitle">
          <table border="0" style="width: 90%; align-content: center;">
            <tr>
              <td>
                <asp:Label ID="lblSubTitle" runat="server" class="titSubControlPanel"></asp:Label></td>
              <td align="right">
      ...
      <tr>
        <td colspan="3" class="tdMarco" align="center">
          <table id="idTblSegNiv" runat="server" border="0" cellpadding="0" cellspacing="0" class="tblPanel">
            <tr style="height: 80px" id="HeaderId" runat="server">
              <td class="clPanel"></td>
              <td class="clPanel"></td>
            </tr>
            <tr>
              <td colspan="12" style="background-color: #00619F; height: 5px;"></td>
            </tr>
          </table>
        </td>
      </tr>
        ...
        <td colspan="3">
          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: center;">
            <tr>
              ...
              <td class="tdPieEjecutivos" style="width: 80%"></td>
              <td style="width: 10%; vertical-align: top;">
